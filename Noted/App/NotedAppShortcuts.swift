...
// MARK: - NotedAppShortcuts (macOS)

/// Surfaces the App Intents from NotedKit to Siri, Spotlight, and the
/// Shortcuts app on macOS. Phrases include the app name explicitly because
/// Apple requires it.
